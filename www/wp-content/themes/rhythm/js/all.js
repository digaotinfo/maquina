...
//        $("#subservicos .owl-wrapper-outer.autoHeight").attr("height", "auto");
    });
...
//			});
			...
			// Fullwidth slider
			$("#escritorios .fullwidth-slider").owlCarousel({
				slideSpeed: 350,
				singleItem: true,
				autoHeight: true,
				pagination: false,
      ...
      $(".fullwidth-gallery").owlCarousel({
        ...
        pagination: false
			...
			// Item carousel entidadesApoiadas
			$("#entidadesApoiadas .item-carousel").owlCarousel({
//				autoPlay: 2500,
				stopOnHover: true,
				items: 3,
				itemsDesktop: [1199, 3],
			...
			// Item carousel relatorioSocial
			$("#relatorioSocial .item-carousel").owlCarousel({
//				autoPlay: 2500,
				stopOnHover: true,
				items: 4,
				itemsDesktop: [1199, 3],
			...
			// Item carousel Trabalhe Conosco
			$("#trabalhe .item-carousel").owlCarousel({
//				autoPlay: 2500,
				stopOnHover: true,
				items: 2,
				itemsDesktop: [1199, 3],
			...
			// Item carousel
			$("#equipe .item-carousel").owlCarousel({
//				autoPlay: 2500,
				stopOnHover: true,
				items: 3,
				itemsDesktop: [1199, 3],
			...
			// Blog posts carousel
			$("#subservicos .blog-posts-carousel-subservicos").owlCarousel({
				stopOnHover: true,
				slideSpeed: 350,
				singleItem: true,
				autoHeight: false,
...
//			});
			...
			// Blog posts carousel alt ultimasNoticias
			$("#ultimasNoticias .blog-posts-carousel-alt").owlCarousel({
//				autoPlay: 3500,
				stopOnHover: true,
				slideSpeed: 350,
				singleItem: true,
