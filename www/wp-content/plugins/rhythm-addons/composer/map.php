...
vc_map( array(
	...
	'base'                    => 'rs_promo_slide',
	'icon'                    => 'fa fa-sort-numeric-asc',
	'description'             => 'Add escritorios slide.',
	'as_child'                => array('only' => 'rs_promo_slider'),
	'params'  => array(
		array(
			'type'        => 'attach_image',
...
$member_name = array('Choose member' => '', 'All' => 'all');
...
// get the team member name and append space as default
$equipe_arr = rs_element_values('post', array('post_type' => 'team'));
$equipe_name = array('Choose member' => '', 'All' => 'all');
if (is_array($equipe_arr)) {
	$equipe_name = array_merge($equipe_name,$equipe_arr);
}
vc_map( array(
		'name'          => 'Membros da Equipe',
		'base'          => 'rs_equipe',
		'icon'          => 'fa fa-users',
		'description'   => 'Add Lista de membros da equipe.',
		'params'        => array(
				array(
						'type'        => 'dropdown',
						'heading'     => 'Member',
...
// get the team member name and append space as default
$subservicos_arr = rs_element_values('post', array('post_type' => 'subservicos'));
$subservicos_name = array('Choose sub-servicos' => '', 'All' => 'all');
if (is_array($members_arr)) {
	$subservicos_name = array_merge($subservicos_name,$subservicos_arr);
}
vc_map( array(
		'name'          => 'Sub-Servicos',
		'base'          => 'rs_subservicos',
		'icon'          => 'fa fa-users',
		'description'   => 'Add sub-servicos block.',
		'params'        => array(
				array(
						'type'        => 'dropdown',
						'heading'     => 'Sub-Servicos',
						'description' => 'Select Sub-Servico name to show.',
						'param_name'  => 'person_id',
						'value'       => $subservicos_name,
						'admin_label' => true,
				),
				// Extras
				$vc_map_extra_id,
...
$tab_unique_id_4 = time() . '-4-' . rand( 0, 100 );
vc_map( array(
	"name"            => 'Tabs',
	'base'            => 'vc_tabs',
	'is_container'    => true,
	...
	'params'          => array(
		...
		array(
			...
			'heading'     => 'Active Tab',
			'param_name'  => 'active',
			'description' => 'You can active any tab as default. Eg. 1 or 2 or 3 or 4'
		),
		$vc_map_extra_id,
		$vc_map_extra_class,
	...
	'default_content' => '
		...
		[vc_tab title="Tab 4" tab_id="' . $tab_unique_id_4 . '"][/vc_tab]',
	'js_view'         => 'VcTabsView'
) );
...
// VC Zoio
// ==========================================================================================
// get the redes sociais member name and append space as default
vc_map( array(
		'name'          => 'Rede Sociais',
		'base'          => 'rs_redesSociais',
		'icon'          => 'fa fa-users',
		'description'   => 'Add social block.',
		'params'          => array(
		),
...
// ==========================================================================================
// Entidades Apoiadas BLOCK
// ==========================================================================================
vc_map( array(
		'name'          => 'Entidades Apoiadas',
		'base'          => 'rs_entidadesApoiadas',
		'icon'          => 'fa fa-users',
		'description'   => 'Add Entidades Apoiadas block.',
		'params'        => array(
				// Extras
				$vc_map_extra_id,
				$vc_map_extra_class,
...
// ==========================================================================================
// Relatório Social BLOCK
// ==========================================================================================
vc_map( array(
		'name'          => 'Relatório Social',
		'base'          => 'rs_socialRelatorio',
		'icon'          => 'fa fa-users',
		'description'   => 'Add Relatório Social block.',
		'params'        => array(
				// Extras
				$vc_map_extra_id,
				$vc_map_extra_class,
...
// ==========================================================================================
// LISTA DE SERVIÇOS BLOCK
// ==========================================================================================
vc_map( array(
		'name'          => 'Lista de Serviços',
		'base'          => 'rs_servicosList',
		'icon'          => 'fa fa-users',
		'description'   => 'Add Lista de Serviços block.',
		'params'        => array(
				// Extras
				$vc_map_extra_id,
				$vc_map_extra_class,
...
// ==========================================================================================
// TRABALHE CONOSCO BLOCK
// ==========================================================================================
vc_map( array(
		'name'          => 'Trabalhe Conosco',
		'base'          => 'rs_trabalheConosco',
		'icon'          => 'fa fa-users',
		'description'   => 'Add Trabalhe Conosco block.',
		'params'        => array(
				// Extras
				$vc_map_extra_id,
				$vc_map_extra_class,
