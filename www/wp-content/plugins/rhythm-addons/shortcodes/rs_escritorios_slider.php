 ...
 *
 */
function rs_escritorios_sliderr( $atts, $content = '', $id = '' ) {
...
add_shortcode('rs_escritorios_sliderr', 'rs_escritorios_sliderr');

function rs_escritorios_slider( $atts, $content = '', $id = '' ) {
...
add_shortcode('rs_escritorios_slider', 'rs_escritorios_slider');
