...
*
*/
function rs_socialRelatorio( $atts, $content = '', $id = '' ) {
	...
	$args = array(
			'category_name' => 'social-relatorio',
			'posts_per_page'=> 10,
...
<div <?php echo $id; ?> class="team-item relatorio-social <?php echo sanitize_html_classes($class); ?>"<?php echo $animation_duration; ?><?php echo $animation_delay; ?>>
    <?php if(has_post_thumbnail()): ?>
    <div class="img">
	    <?php 
	    	$url = esc_url(get_field("relatorioSocial_link"));
	    	if( !empty($url) ){
	    		?>
...
add_shortcode('rs_socialRelatorio', 'rs_socialRelatorio');
