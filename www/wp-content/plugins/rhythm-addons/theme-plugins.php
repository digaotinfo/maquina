...
//     require_once(RS_ROOT .'/custom-posts/socialRelatorio.php');
    require_once(RS_ROOT .'/custom-posts/entidadesApoiadas.php');
//     require_once(RS_ROOT .'/custom-posts/escritorios.php');
    require_once(RS_ROOT .'/custom-posts/redesSociais.php');
    require_once(RS_ROOT .'/custom-posts/subservicos.php');
//     require_once(RS_ROOT .'/custom-posts/trabalheConosco.php');
//     require_once(RS_ROOT .'/custom-posts/servicos.php');
  }
...
//       require_once(RS_ROOT. '/' . 'shortcodes/rs_escritorios.php');
      ...
      require_once(RS_ROOT. '/' . 'shortcodes/rs_equipe.php');
      ...
      require_once(RS_ROOT. '/' . 'shortcodes/rs_subservicos.php');
      ...
      require_once(RS_ROOT. '/' . 'shortcodes/rs_redesSociais.php');
      require_once(RS_ROOT. '/' . 'shortcodes/rs_entidadesApoiadas.php');
      require_once(RS_ROOT. '/' . 'shortcodes/rs_trabalheConosco.php');
      require_once(RS_ROOT. '/' . 'shortcodes/rs_socialRelatorio.php');
      require_once(RS_ROOT. '/' . 'shortcodes/rs_servicosList.php');
    }
